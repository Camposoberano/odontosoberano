...
:: Inicia o servidor em uma janela minimizada e embutida
start "Motor Odonto PRO" /MIN cmd /c "npm run dev"

echo [4/4] Aguardando os motores aquecerem (5 segundos)...
...
echo http://localhost:3000 ou http://localhost:5173
echo.
