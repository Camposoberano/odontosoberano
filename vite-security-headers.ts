...
const csp = [
  ...
  `connect-src 'self' https://*.supabase.co https://api.ipify.org wss://*.supabase.co https://viacep.com.br https://bancodedados.soberano.pro wss://bancodedados.soberano.pro ${COOLIFY_URL} ${COOLIFY_WS}`,
