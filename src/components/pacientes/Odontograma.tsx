...
export function Odontograma({ pacienteId }: OdontogramaProps) {
  ...
  const { odontograma, loading, createOdontograma, updateOdontograma, refetch } = useOdontograma(pacienteId);
  ...
  const handleSave = async () => {
    ...
    try {
      if (odontograma) {
        ...
        await createOdontograma({ paciente_id: pacienteId, dados_dentes: dadosDentes, observacoes });
      }
    } catch (error) {
