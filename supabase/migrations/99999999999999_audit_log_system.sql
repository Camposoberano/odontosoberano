...
DROP TRIGGER IF EXISTS audit_protocolo_provisorio ON public.protocolo_provisorio;
CREATE TRIGGER audit_protocolo_provisorio
  AFTER INSERT OR UPDATE OR DELETE ON public.protocolo_provisorio
  FOR EACH ROW EXECUTE FUNCTION public.trigger_audit_log();

DROP TRIGGER IF EXISTS audit_protocolo_definitivo ON public.protocolo_definitivo;
CREATE TRIGGER audit_protocolo_definitivo
  AFTER INSERT OR UPDATE OR DELETE ON public.protocolo_definitivo
  FOR EACH ROW EXECUTE FUNCTION public.trigger_audit_log();
