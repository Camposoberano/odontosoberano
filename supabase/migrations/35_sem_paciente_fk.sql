...
-- Odonto Soberano - Migração 35 (SEM FK PACIENTE)
-- ============================================

-- ============================================
-- 1. CRIAÇÃO DE ENUMS (TIPOS) - APENAS SE NÃO EXISTIR
-- ============================================
...
CREATE TABLE IF NOT EXISTS procedimentos_ppr (
    ...
    paciente_id UUID, -- SEM foreign key por enquanto
    ...
    -- Constraints
    CONSTRAINT unique_user_os UNIQUE(user_id, ordem_servico)
);
...
-- ============================================
-- 6. REMOVER VIEWS ANTIGAS E RECRIAR
-- ============================================
...
CREATE INDEX IF NOT EXISTS idx_procedimentos_ppr_user_id ON procedimentos_ppr(user_id);
...
CREATE INDEX IF NOT EXISTS idx_doutores_user_id ON doutores(user_id);
CREATE INDEX IF NOT EXISTS idx_doutores_ativo ON doutores(ativo);
CREATE INDEX IF NOT EXISTS idx_proteticos_user_id ON proteticos(user_id);
